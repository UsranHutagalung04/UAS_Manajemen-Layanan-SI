...
<head>
    ...
    <title>Export - SI LAKAM UIN IB Padang</title>
    <!-- Bootstrap core CSS-->
            ...
            buttons: [
                {
                    ...
                    customize: function ( win ) {
                        ...
                        .css( 'font-size', '10pt' )
                        .prepend(
                            '<img src="http://www.surabaya.bpk.go.id/wp-content/uploads/2015/07/uinib.png" style="opacity: 0.5; display:block;margin-left: auto; margin-top: auto; margin-right: auto; width: 100px;" />'
                        );
                    }
                },
                {
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p style="text-align : center;">Copyright © Usran Developer | Usran Bangun Fajar Hutagalung</p>
                    </div>
                    <div class="modal-footer">
