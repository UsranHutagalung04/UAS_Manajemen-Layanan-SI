...
<?php
    ...
    if (isset($_POST['Balas'])) {
        ...
        $isi_tanggapan = $_POST['isi_tanggapan'] ?? null;
        $admin = "Admin";
    
        if (empty($id_laporan) || empty($isi_tanggapan)) {
            die("ID laporan atau isi tanggapan tidak boleh kosong.");
        }
    
        try {
            // Insert into tanggapan
            $sql = "INSERT INTO `tanggapan` (`id_tanggapan`, `id_laporan`, `admin`, `isi_tanggapan`, `tanggal_tanggapan`) 
                    VALUES (NULL, :id_laporan, :admin, :isi_tanggapan, CURRENT_TIMESTAMP)";
            $stmt = $db->prepare($sql);
            ...
            $statement = $db->prepare("UPDATE `laporan` SET `status` = 'Ditanggapi' WHERE `id` = :id_laporan");
...
<head>
    ...
    <title>Table - SI LAKAM UIN IB Padang</title>
    <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <a class="navbar-brand" href="index">SI LAKAM UIN IB Padang</a>
        ...
        <footer class="sticky-footer">
            <div class="container">
                <div class="text-center">
                    <small>Copyright © Usran Developer | UIN Imam Bonjol Padang</small>
                </div>
            </div>
        </footer>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p style="text-align : center;">Copyright © Usran Developer | UIN Imam Bonjol Padang</p>
                    </div>
                    <div class="modal-footer">
