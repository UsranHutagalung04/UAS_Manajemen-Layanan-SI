        ...
        <div class="main-content">
            ...
            <div class="row">
                <div class="col-md-8 card-shadow-2 form-custom">
                    <form class="form-horizontal" role="form" method="post" action="validasi">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="tujuan">
                                        <option value="1">Pelayanan Fasilitas Universitas</option>
                                        <option value="2">Pelayanan Fasilitas Fakultas</option>
                                        <option value="3">Pengelolaan Informasi Administrasi Akademik dan Kemahasiswaan</option>
                                        <option value="4">Pemanfaatan Data Dan Inovasi Pelayanan kepegawaiaan</option>
                                    </select>
                                </div>
                            </div>
                        </div>
        ...
        <footer class="footer text-center">
            <div class="row">
                <div class="col-md-4 mb-5 mb-lg-0">
                    ...
                    <p class="mb-0">
                    Jalan Sungai Bangek, Koto Tangah <br>
