<?php
# @Author: Usran Bangun Fajar Hiutagalung
# @Date:   15 November 2024
# @Copyright: (c) usrandeveloper
?>
<?php
...
<body>
        ...
        <div class="modal-dialog modal-sm " role="document">
            <div class="modal-content bg-2">
                ...
                <div class="modal-body">
                    <p class="text-center">Terimakasih Atas laporan anda</p>
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">
                        <img alt="Brand" src="images/uin.png">
                    </a>
                </div>
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item">
                ...
                <div class="carousel-caption">
                    <h2 class="animated bounceInDown">Pimpinan</h2>
                </div>
            </div>
            <div class="item">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box">
                        ...
                        <div class="info">
                            ...
                            <div class="fb-page" data-height="300" data-width="500" data-href="https://www.facebook.com/share/14stm8yC7X/?mibextid=LQQJ4d" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                                <blockquote cite="https://www.facebook.com/dispendukcapilbkl" class="fb-xfbml-parse-ignore">
                                    <a href="https://www.facebook.com/dispendukcapilbkl">UIN Imam Bonjol Padang</a>
                                </blockquote>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="footer text-center">
        <div class="row">
            <div class="col-md-4 mb-5 mb-lg-0">
                ...
                <p class="mb-0">
                    Jalan Sungai Bangek, Koto Tangah
            ...
            <div class="col-md-4">
                ...
                <p class="mb-0">
                    031-3095331 <br>
                    bagianumumdanrumahtanggga@uinib.ac.id <br>
                    akademikdankemahasiswaan@uinib.ac.id
                </p>
            </div>
        </div>
    </footer>
    ...
    <div class="copyright py-4 text-center text-white">
        <!-- <div class="container"> -->
        <small>Copyright &copy; UsranDeveloper | UIN Imam Bonjol Padang</small>
        <!-- </div> -->
    </div>
    <!-- shadow -->
</div>
